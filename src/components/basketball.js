...
class CourtBounds extends React.Component {
  render() {
    ...
    let courtwidth = xend - xstart
    let threeradiusx = this.props.xscale(237.5) - hoopcenterx
    ...
    let centerarc = describeArc(hoopcenterx, ystart, this.props.xscale(60) - hoopcenterx, hoopcentery - this.props.yscale(60), 0, 180)
    let innercenterarc = describeArc(hoopcenterx, ystart, this.props.xscale(20) - hoopcenterx, hoopcentery - this.props.yscale(20), 0, 180)
    let freethrowwidth = this.props.xscale(160) - this.props.xscale(0)
    let freethrowheight = Math.abs(this.props.yscale(-47.5 + 190) - yend)
    let freethrowinnerarc = describeArc(hoopcenterx, this.props.yscale(-47.5 + 190), this.props.xscale(60) - hoopcenterx, hoopcentery - this.props.yscale(60), 0, 180)
    let freethrowouterarc = describeArc(hoopcenterx, this.props.yscale(-47.5 + 190), this.props.xscale(60) - hoopcenterx, hoopcentery - this.props.yscale(60), -180, 0)
    let restrictedArc = describeArc(hoopcenterx, hoopcentery, this.props.xscale(40) - hoopcenterx, hoopcentery - this.props.yscale(40), -180, 0)

    return <g>
      {/* hoop */}
      <ellipse stroke="#000" fill="none" cx={this.props.xscale(0)} cy={this.props.yscale(0)} rx={this.props.xscale(7.5) - this.props.xscale(0)} ry={this.props.yscale(0) - this.props.yscale(7.5)} />
      ...
      <rect fill="none" stroke="#000" x={this.props.xscale(-60)} y={this.props.yscale(-47.5 + 190)} width={this.props.xscale(120) - this.props.xscale(0)} height={freethrowheight} />
