...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsRect = __webpack_require__(11);
	...
	var TransitionRect = (0, _componentsMark2['default'])(_componentsRect2['default'], [{ prop: 'width', duration: 300, easing: _reactTweenState.easingTypes.easeInOutQuad }, { prop: 'height', duration: 600, easing: _reactTweenState.easingTypes.linear }]);
	
	var RectGroup = (function (_React$Component) {
	  _inherits(RectGroup, _React$Component);
	
	  function RectGroup() {
	    _classCallCheck(this, RectGroup);
	
	    _get(Object.getPrototypeOf(RectGroup.prototype), 'constructor', this).apply(this, arguments);
	  }
	
	  _createClass(RectGroup, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement('g', _extends({}, this.props, { transform: 'translate(' + this.props.x + ', ' + this.props.y + ')' }));
	    }
	  }]);
	...
	var TransitionGroup = (0, _componentsMark2['default'])(RectGroup, [{ prop: 'y', duration: 900, easing: _reactTweenState.easingTypes.linear, start: height }]);
	
	var bars = data.map(function (d, i) {
	  return _react2['default'].createElement(
	    TransitionGroup,
	    { key: i, className: 'bar', x: xscale(d.x), y: yscale(d.y) },
	    _react2['default'].createElement(TransitionRect, { width: xscale(d.dx) - 1, height: height - yscale(d.y) }),
...
/***/ }
/******/ ]);
//# sourceMappingURL=react-histogram-transition.js.map